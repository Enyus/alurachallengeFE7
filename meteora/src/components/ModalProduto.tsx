    ...
    <dialog open className="fixed top-0 left-0 right-0 p-1 h-full w-full rounded overflow-y-scroll sm:py-4 sm:px-[10%] bg-transparent sm:overflow-auto z-10 backdrop-brightness-50">
      ...
      <div className="p-4 sm:flex bg-white rounded-b">
        ...
        <div className="py-6 px-2 sm:w-1/2">
            ...
            <span className="block font-medium text-xl mb-6">{formatPreco(props.preco / 100)}</span>
            ...
            <div>
                <span className="text-[13px] pb-4 font-bold">Cores:</span>
            ...
            <div>
                <span className="text-[13px] pb-4 font-bold">Tamanho:</span>
