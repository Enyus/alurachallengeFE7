        ...
        <div className="py-6 px-2 sm:w-1/2">
            ...
            <div>
                ...
                <ul className="flex text-[13px] gap-4 pb-4 border-b border-primary-gray mb-4">
                    <div className="flex flex-col items-center">
                        <input type="radio" id="corAzulClaro" name="cor" className="relative appearance-none h-[4px) w-[4px] rounded-[50%] border bg-blue-300 checked:bg-primary-purple checked:after:content-[''] checked:after:absolute checked:after:h-[7px] checked:after:w-[7px] checked:after:rounded-[50%] checked:after:bg-blue-300 checked:after:top-[3px] checked:after:left-[3px]" />
                        <label htmlFor="corAzulClaro">Azul Claro</label>
                    </div>
                    <div className="flex flex-col items-center">
                        <input type="radio" id="corOffWhite" name="cor" className="relative appearance-none h-[4px] w-[4px] rounded-[50%] border bg-white checked:bg-primary-purple checked:after:content-[''] checked:after:absolute checked:after:h-[7px] checked:after:w-[7px] checked:after:rounded-[50%] checked:after:bg-white checked:after:top-[3px] checked:after:left-[3px]" />
                        <label htmlFor="corOffWhite">Offwhite</label>
                    </div>
                    <div className="flex flex-col items-center">
                        <input type="radio" id="corPreto" name="cor" className="relative appearance-none h-[4px] w-[4px] rounded-[50%] border bg-black checked:bg-primary-purple checked:after:content-[''] checked:after:absolute checked:after:h-[7px] checked:after:w-[7px] checked:after:rounded-[50%] checked:after:bg-black checked:after:top-[3px] checked:after:left-[3px]" />
            ...
            <div>
                ...
                <ul className="flex text-[13px] gap-4 pb-4 border-b border-primary-gray mb-4 text-center">
                    <div className="flex flex-col items-center">
                        <input type="radio" id="tamanhoP" name="tamanho" className="relative appearance-none h-[4px] w-[4px] rounded-[50%] border checked:bg-primary-purple checked:after:content-[''] checked:after:absolute checked:after:h-[7px] checked:after:w-[7px] checked:after:rounded-[50%] checked:after:z-10 checked:after:bg-white checked:after:top-[3px] checked:after:left-[3px]" />
